  ...
  const features = [
    {
      title: "Social Feed",
      description:
        "Connect with peers, share updates, and stay informed with a personalized feed",
      icon: PenSquare,
    ...
    },
    {
      ...
      description:
        "Seamless communication with project members and friends in real-time",
      icon: MessageSquare,
    ...
    },
    {
      ...
      description:
        "Create or join projects and collaborate with talented developers",
      icon: Briefcase,
    ...
    },
    {
      ...
      description:
        "Showcase your skills, track your ratings, and build your reputation",
      icon: UserCircle,
    ...
    },
    {
      ...
      description:
        "Stay updated with real-time notifications for all activities",
      icon: BellRing,
  ...
  const testimonials = [
    {
      ...
      quote:
        "Teamify transformed how I collaborate. I've found amazing projects and built connections that advanced my career.",
    },
    {
      name: "Sarah Chen",
      role: "UX Designer",
      ...
      quote:
        "The platform's intuitive design and powerful features make collaboration seamless. I've grown my network exponentially.",
    },
    {
      ...
      quote:
        "From idea to execution, Teamify provides all the tools needed to build successful projects with talented people.",
    },
  ];
  ...
  const steps = [
    {
      ...
      description:
        "Showcase your skills, experience, and interests to stand out",
      icon: UserCircle,
      color: "bg-blue-500",
    },
    {
      ...
      description:
        "Browse the feed, connect with peers, and discover exciting projects",
      icon: Globe2,
      color: "bg-purple-500",
    },
    {
      ...
      description:
        "Find the perfect project or start your own and recruit talent",
      icon: Briefcase,
      color: "bg-indigo-500",
    },
    {
      ...
      description:
        "Work together, communicate in real-time, and build your reputation",
      icon: Zap,
      color: "bg-pink-500",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="relative overflow-hidden">
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Connect with passionate developers, collaborate on exciting
            projects, and build your professional network. All in one powerful
      ...
      >
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Join our growing community of developers and creators building the
            future together
          </p>
        </div>
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-6">
                  <div className={`p-3 ${feature.bgColor} rounded-xl`}>
                    <feature.icon
                      className={`w-6 h-6 text-gradient bg-gradient-to-r ${feature.color}`}
                    />
                  </div>
      ...
      >
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Your journey from sign-up to successful collaboration in four simple
            steps
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="grid md:grid-cols-4 gap-8 relative z-10">
            {steps.map((step, index) => (
              ...
              >
                <div
                  className={`${step.color} w-16 h-16 rounded-full flex items-center justify-center mb-6 shadow-lg`}
                >
