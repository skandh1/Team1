...
import { chatClientService } from "../lib/chatClient.ts";
import {
  UserIcon,
  MessageSquare,
  Loader2,
...
const ChatComponent = () => {
    ...
    return (
      <div className="h-screen flex items-center justify-center bg-gradient-to-br from-red-50 via-pink-50 to-red-50">
        <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-xl text-center max-w-md">
          ...
          <h3 className="text-xl font-semibold text-red-600 mb-2">Chat Initialization Failed</h3>
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-6">
      <div className="max-w-7xl mx-auto h-[90vh] bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden flex">
        {/* Users Sidebar */}
